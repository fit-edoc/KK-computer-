  ...
  return (
    ...
    <div className='min-h-[100vh] w-screen bg-gradient-to-br from-[#351467] via-[#35013c] to-[#8f37a1] grid grid-cols-3 gap-[30px] px-3 py-2'>
        ...
        {pricecard.map((item,idx)=>(
            ...
            <div className='h-[40%] w-full flex items-center justify-around'> <b className='text-[40px]'>₹4500</b> <a href="https://docs.google.com/forms/d/1vvABdxAMXTsMao7LRwb-cxZ6wueevJ48UwCDQbdMSeQ/edit"><button className='py-2 px-3 rounded-full bg-[#dfd69b]'>Start now</button></a></div>
            </div>
